      ...
      require('react').createElement(
        require('../../../node_modules/@umijs/preset-dumi/lib/themes/default/layout.js').default,
        {
          ...{
                ...
                '/forms': [
                  {
                    ...
                    meta: {},
                    children: [
                      { path: '/forms/form/aautocomplete', title: 'AAutoComplete', meta: {} },
                      { path: '/forms/form/acascader', title: 'ACascader', meta: {} },
                      { path: '/forms/form/acheckboxgroup', title: 'ACheckboxGroup', meta: {} },
                      { path: '/forms/form/adatepicker', title: 'ADatePicker', meta: {} },
                      { path: '/forms/form/adaterangepicker', title: 'ADateRangePicker', meta: {} },
                      {
                      ...
                      { path: '/forms/form/adynamic-select', title: 'ADynamicSelect', meta: {} },
                      {
                        path: '/forms/form/adynamic-selectgroup',
                        title: 'ADynamicSelectGroup',
                        meta: {},
                      },
                      { path: '/forms/form/adynamic-tree', title: 'ADynamicTree', meta: {} },
                      {
                        path: '/forms/form/adynamic-treeselect',
                        title: 'ADynamicTreeSelect',
                        meta: {},
                      },
                      { path: '/forms/form/ainput', title: 'AInput', meta: {} },
                      { path: '/forms/form/aradiogroup', title: 'ARadioGroup', meta: {} },
                      { path: '/forms/form/aselect', title: 'ASelect', meta: {} },
                      { path: '/forms/form/aselectgroup', title: 'ASelectGroup', meta: {} },
                      { path: '/forms/form/aswitch', title: 'ASwitch', meta: {} },
                      { path: '/forms/form/atimepicker', title: 'ATimePicker', meta: {} },
                      { path: '/forms/form/atree', title: 'ATree', meta: {} },
                      { path: '/forms/form/atreeselect', title: 'ATreeSelect', meta: {} },
                      { path: '/forms/form/aupload', title: 'AUpload', meta: {} },
                    ],
                  },
                ],
                '*': [{ path: '/', title: '介绍', meta: {} }],
            ...
            mode: 'site',
            repoUrl: 'https://github.com/aiolosjs/components',
          },
          ...props,
        },
      ),
